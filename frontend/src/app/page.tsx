...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-950 selection:bg-indigo-100 dark:selection:bg-indigo-900 selection:text-indigo-900 dark:selection:text-indigo-100">
      <Header />
      <main className="flex-1">
        ...
        <section id="pricing" className="py-24 bg-white dark:bg-gray-950">
          <div className="container px-4 md:px-6 mx-auto text-center">
            ...
            <div className="p-8 border rounded-2xl bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 max-w-md mx-auto">
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Pro Plan</h3>
              <div className="text-4xl font-bold mb-4 text-gray-900 dark:text-white">$29<span className="text-lg font-normal text-gray-500 dark:text-gray-400">/mo</span></div>
              ...
              <button type="button" className="w-full py-2 px-4 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
                Get Started
              </button>
            </div>
          </div>
      ...
      <footer className="py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
